...
namespace SofarHVMExe.UserControls
{
    ...
    public partial class MyDateTimePicker : UserControl
    {
        ...
        public static readonly DependencyProperty TimeChangeCommandProperty =
            DependencyProperty.Register("TimeChangeCommand", typeof(ICommand), typeof(MyDateTimePicker), new PropertyMetadata(null));

        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="txt"></param>
        public MyDateTimePicker(string txt)
            : this()
        {
        ...
        public static readonly RoutedEvent TimeTextChangedEvent =
             EventManager.RegisterRoutedEvent("TimeTextChanged", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(MyDateTimePicker));
        ...
        public static readonly DependencyProperty DateTimeProperty =
            DependencyProperty.Register("DateTimeStr", typeof(string), typeof(MyDateTimePicker));
        #endregion
    }
}
